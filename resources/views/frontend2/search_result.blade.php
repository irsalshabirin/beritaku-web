    ...
    <div class="wrap">
        <div class="col-md-8 content-left">
            ...
            @if(isset($results))
                <div class="articles">
                    <header>
                        <h3 class="title-head">Hasil Pencarian : {{ $q }}</h3>
                    </header>
                    @foreach($results as $result)
                    	<div class="article">

                            @if(($result->media_content_url))
                                <div class="article-left">
                                    <a href="{{ url('2/article/' . $result->id) }}">
                                        <div class="center-cropped">
                                                <img src="{{ $result->media_content_url }}"  onerror="ImgError(this);"/>
                                        </div>
                                    </a>
                                </div>
                                <div class="article-right">
                                    <div class="article-title">
                                        <p>
                                            <!-- On Feb 25, 2015  -->
                                            {{ \Carbon\Carbon::createFromTimeStamp(strtotime($result->publish_date))->diffForHumans() }}
                                        ...
                                        <a class="title" href="{{ url('2/article/' . $result->id) }}"> {{ str_limit($result->title, $limit = 60, $end = '...') }} </a>
                                    </div>
                                    <div class="article-text">
                                        <p>{{ str_limit(preg_replace('/[\x00-\x1F\x80-\xFF]/', '', preg_replace('/\s+/', ' ', strip_tags($result->content))), $limit = 200, $end = '...') }}</p>
                                        <!-- <a href="single.html">
                            ...
                            @elseif($result->media_content_url == "")
                                <div class="article-title">
                                    <p>
                                        <!-- On Feb 25, 2015  -->
                                        {{ \Carbon\Carbon::createFromTimeStamp(strtotime($result->publish_date))->diffForHumans() }}
                                    ...
                                    <a class="title" href="{{ url('2/article/' . $result->id) }}"> {{ str_limit($result->title, $limit = 70, $end = '...') }} </a>
                                </div>
                                <div class="article-text">
                                    <p>{{ str_limit(preg_replace('/[\x00-\x1F\x80-\xFF]/', '', preg_replace('/\s+/', ' ', strip_tags($result->content))), $limit = 400, $end = '...') }}</p>
                                    <!-- <a href="single.html">
                                        <img src="images/more.png" alt="" />
                                    </a> -->
                                    <p>tag : {{ $result->word }}</p>
